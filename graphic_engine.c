...
{
  Id id_act = NO_ID, id_back = NO_ID, id_next = NO_ID, obj_loc = NO_ID, player_loc = NO_ID;
  ...
  if ((id_act = player_get_id(game->bob)) != NO_ID)
  {
    ...
    if (object_get_id(game->obj) == id_back)
      obj = '*';
    else
      obj = ' ';
    ...
    if (object_get_id(game->obj) == id_act)
      obj = '*';
    else
      obj = ' ';
    ...
    if (object_get_id(game->obj) == id_next)
      obj = '*';
    else
      obj = ' ';
